...
import { Files, Film } from '@element-plus/icons-vue'

const title = 'Easier Said Than Done: Understanding the Gap between Intent and Behavior Jailbreaks in LLM-based Robots'
...
const buttons = [
  {
    disabled: false,
    name: "Datasets",
    link: "https://anonymous.4open.science/r/Harmful-Behavior/",
    component: Files,
  },
  {
    disabled: false,
    name: "Code",
    link: "https://anonymous.4open.science/r/POEF/",
    component: Files,
  },
]
