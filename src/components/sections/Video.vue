  ...
  <div>
    ...
    <el-row justify="center">
      <el-col :xs="24" :sm="20" :md="16" :lg="12" :xl="10">
        ...
        <h3 class="video-title">Main Demo: POEF Jailbreak Attack</h3>
      </el-col>
    </el-row>
      ...
      <el-col :xs="24" :sm="20" :md="20" :lg="18" :xl="16">
        <el-row :gutter="20">
          ...
          <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
            <el-container class="video-container small-video">
              <video controls>
                <source src="/videos/Demo4.mp4" type="video/mp4">
              </video>
            </el-container>
      ...
      <el-col :xs="24" :sm="20" :md="20" :lg="18" :xl="16">
        <el-row :gutter="20">
          <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
            <el-container class="video-container small-video">
              <video controls>
                <source src="/videos/Demo5.mp4" type="video/mp4">
              </video>
            </el-container>
          ...
          <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
            <el-container class="video-container small-video">
              <video controls>
                <source src="/videos/Demo6.mp4" type="video/mp4">
              </video>
            </el-container>
          ...
          <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
            <el-container class="video-container small-video">
              <video controls>
                <source src="/videos/Demo7.mp4" type="video/mp4">
              </video>
            </el-container>
          ...
          <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
            <el-container class="video-container small-video">
              <video controls>
                <source src="/videos/Demo9.mp4" type="video/mp4">
              </video>
            </el-container>
            <h4 class="video-subtitle">stab the person with the knife (under attack)</h4>
          </el-col>
